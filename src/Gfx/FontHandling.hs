...
import           Graphics.Rendering.FreeType.Internal                (ft_Done_Face,
                                                                      ft_Done_FreeType,
                                                                      ft_Get_Char_Index,
                                                                      ft_Init_FreeType,
                                                                      ft_Load_Glyph,
                                                                      ...
                                                                      ft_Render_Glyph,
                                                                      ft_Set_Pixel_Sizes)
import qualified Graphics.Rendering.FreeType.Internal.Bitmap         as BM
...
import           Graphics.Rendering.FreeType.Internal.PrimitiveTypes (FT_Error, ft_RENDER_MODE_NORMAL)
import qualified Graphics.Rendering.FreeType.Internal.Size           as FS
import qualified Graphics.Rendering.FreeType.Internal.SizeMetrics    as FSM
...
import           Graphics.Rendering.OpenGL                           (Clamping (ClampToEdge),
                                                                      ...
                                                                      PixelStoreDirection (Pack, Unpack),
                                                                      Proxy (NoProxy),
                                                                      Repetition (Repeated),
